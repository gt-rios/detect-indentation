...
export default {
  ...
  init(statusBar) {
    ...
    this.element.classList.add('detect-indentation-status', 'inline-block');
  ...
  destroy() {
    ...
    if (this.tile !== null) this.tile.destroy();
    if (this.tooltip !== null) this.tooltip.dispose();
  },

  attach() {
    this.tile = this.statusBar.addRightTile({ item: this.element, priority: 201 });
  },
